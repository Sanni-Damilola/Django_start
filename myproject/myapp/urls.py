...
from .views import index, student_details, home, about, calculate,notfound, result, Result, allStudent, studentUpdate, createStudent, getOneStudent, deleteStudent, createDev
...
urlpatterns = [
    ...
    path("createDev", createDev, name="createDev")
]